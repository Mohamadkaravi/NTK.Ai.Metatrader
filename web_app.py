...
async def lifespan(app: FastAPI):
    # Startup
    print("🚀 Starting NTK.Ai.Metatrader Multi-Agent Trading Platform by Mohamad Karavi...")
    mt5_service.connect()
...
app = FastAPI(
    ...
    description="Multi-Agent AI Trading Signal Platform & MetaTrader 5 Bridge by Mohamad Karavi (https://mohamadkaravi.com/)",
    lifespan=lifespan
)
...
class AgentRegisterRequest(BaseModel):
    name: str
    email: str = "bot@mohamadkaravi.com"
...
async def get_printable_trade_journal_html():
    ...
    <body>
        ...
        <div style="text-align: center; margin-top: 30px; font-size: 10px; color: #94a3b8; border-top: 1px solid #e2e8f0; padding-top: 10px;">
            NTK.Ai.Metatrader - Institutional Algorithmic & AI Trading Engine • Mohamad Karavi (<a href="https://mohamadkaravi.com/" style="color: #64748b;">mohamadkaravi.com</a>)
        </div>
    </body>
    </html>
    """
...
async def chat_with_agent(payload: ChatPayload):
    ...
    system_content = (
        "You are NTK.Ai.Metatrader assistant developed by Mohamad Karavi (https://mohamadkaravi.com/). "
