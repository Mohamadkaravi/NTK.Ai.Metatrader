...
class ScrollableSettingsFrame(ctk.CTkScrollableFrame):
    ...
    def __init__(self, master, app: "App", **kwargs):
        ...
        sub_lbl = ctk.CTkLabel(
            self,
            text="NTK.Ai.Metatrader - Developed by Mohamad Karavi (https://mohamadkaravi.com/)",
            font=(FONT_FAMILY, 10),
            text_color="#888888",
            anchor="w",
        )
...
class App(ctk.CTk):
    ...
    def __init__(
        ...
        title: str = "NTK.Ai.Metatrader - Mohamad Karavi",
        width: int = 560,
        height: int = 740,
    ):
        super().__init__()
        ...
        self.add_message(
            "assistant",
            "Hello! I'm NTK.Ai.Metatrader assistant (by Mohamad Karavi - https://mohamadkaravi.com/).\n"
